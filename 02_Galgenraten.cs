...
namespace Galgenraten
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                while (verwendetProbe < maxAnzahlProbe)
                {
                    ...
                    obGeloest = benutzerWortAntwort == wort.EntnehmenOeffentlch();
                    if (obGeloest)
                        break;
                ...
                if (wort.ObErraten() || obGeloest)
                {
                    ...
                    Console.WriteLine("Das geheimes Lösungswort ist " + wort.EntnehmenOeffentlch());
                }
                else
                {
        ...
        public class Wort
        {
            ...
            public string EntnehmenOeffentlch() 
            {
                string aufschrift = "";
